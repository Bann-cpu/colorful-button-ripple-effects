...
function displateItems() {
  ...
  for (let i = 0; i < itemsArray.length; i++) {
    //loop the itemArray grâce au fait que tu peux pas être inférieur à 0 donc infini = alors il incrémente
...
window.onload = function () {
  //quand le window est chargé on execute la fonction displayDate
  displayDate();
  displateItems();
};
